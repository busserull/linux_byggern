...
\\
The GATT heavily relies on the ATT, but to further convolute matters more, the GATT introduces some new concepts and terminology. The most important difference the GATT introduces is data organization. In GATT, data is ordered in a hierarchy of so-called \textit{services}. A service is a collection of \textit{characteristics}, and a set of relationships to other services. Characteristics are just conceptually similar pieces of data grouped together.\\
\\
